                                ...
                                <div class="col-lg-6">
                                    <div class="pulse animated p-5">
                                        ...
                                        <form class="user" action="<?php echo site_url('login/verify_admin'); ?>" method="post">
                                            <div class="mb-3"><input class="form-control form-control-user" type="email" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email Address..." name="email" value="<?php echo $admin['email'] ?>"></div>
                                            <div class="mb-3"><input class="form-control form-control-user" type="password" id="exampleInputPassword" placeholder="Password" name="pwd" value="<?php echo $admin['mdp'] ?>"></div>
                                            <div class="mb-3">
                                        ...
                                        <div class="text-center"><a class="small" style="color: #01703E;" href="<?php echo site_url('login/inscription'); ?>">S'inscrire en tant que simple utilisateur</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
