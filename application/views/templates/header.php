        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse list" id="navcol-5">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?php echo site_url('welcome/listeObjetByUser')?>">Your Objects</a></li> 
                    <li class="nav-item"><a class="nav-link" href="<?php echo site_url('welcome/listeObjet')?>">All Objects</a></li> 
